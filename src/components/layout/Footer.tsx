  ...
  return (
    <footer style={{ background: 'var(--green-deep)', color: 'white', marginTop: 64 }}>
      <div className="container" style={{ padding: '48px 1rem 32px' }}>
        ...
        <div className="footer-bottom" style={{ borderTop: '1px solid rgba(255,255,255,0.15)', paddingTop: 24, display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
